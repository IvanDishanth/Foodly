...
const Home = () => {
  ...
  // Function to handle the click and scroll to the About section
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-20 mt-40 flex items-center justify-center" style={{ width: 500, height: 500 }}>
          ...
          <img
            ...
            onClick={handleFoodImageClick} // Call the scroll function here
      ...
      {/* Attach the ref to the About component's root element */}
      {/* It's often best to wrap a component you want to scroll to in a div with the ref */}
